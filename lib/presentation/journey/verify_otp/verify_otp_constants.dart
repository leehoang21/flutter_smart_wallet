...
class VerifyAccountConstants {
  ...
  static String notReceivecode =
      translate('otp_screen_didn_t_receive_the_code');
  static String resend = translate('otp_screen_resend');
  static String confirm = translate('otp_screen_confirm');
  static double widthFieldInput = 44.w;
  static double distanceTextToFieldInput = 25.h;
